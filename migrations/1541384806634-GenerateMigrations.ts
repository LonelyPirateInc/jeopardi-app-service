...
export class GenerateMigrations1541384806634 implements MigrationInterface {

    public async up(queryRunner: QueryRunner): Promise<any> {
        await queryRunner.query("CREATE TABLE `category` (`id` int NOT NULL, `categoryText` varchar(255) NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `question` (`id` varchar(255) NOT NULL, `questionText` varchar(255) NOT NULL, `isActive` tinyint NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `categoryId` int NULL, `gameId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        await queryRunner.query("CREATE TABLE `answer` (`id` varchar(255) NOT NULL, `answerText` varchar(255) NOT NULL, `point` int NOT NULL, `isCorrect` tinyint NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `questionId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("ALTER TABLE `question` ADD CONSTRAINT `FK_b8dd754e373b56714ddfa8f545c` FOREIGN KEY (`categoryId`) REFERENCES `category`(`id`)");
        await queryRunner.query("ALTER TABLE `question` ADD CONSTRAINT `FK_80c7fd5c83ca68cfbf33c0daf6c` FOREIGN KEY (`gameId`) REFERENCES `game`(`id`)");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `question` DROP FOREIGN KEY `FK_80c7fd5c83ca68cfbf33c0daf6c`");
