...
export class GenerateMigrations1542005992141 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `question` (`id` varchar(255) NOT NULL, `questionText` varchar(500) NOT NULL, `musicName` varchar(500) NOT NULL, `musicNamePath` varchar(500) NOT NULL, `difficulty` int NOT NULL, `isActive` tinyint NOT NULL, `isCurrent` tinyint NOT NULL, `createdAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `updatedAt` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), `category_id` int NULL, `game_id` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
